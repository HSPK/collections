...
Independent URL: `/projects/gravity/`.
...
object limit, pointer cancellation, and keyboard alternatives. Shared
interaction lifecycle helpers handle cleanup and control resets.

Regenerate `public/previews/gravity.jpg` when changing its initial toys.
